...
date: '2025-05-01'
lastmod: '2025-05-01'
tags: ['インフラ', 'ブログ開発', 'Cloudflare', 'DNS']
draft: false
...
![](/static/images/image-20250501121951662-20250503163755-873b989c.png)
...
![image-20250501111638290](/static/images/image-20250501111638290-20250503163755-9377917c.png)

## WHOIS情報とは

ドメインの登録が完了すると以下のようなWHOIS情報が表示されます。WHOISとは誰が・いつ・どこでドメインを取得したかを公開する仕組みです。

![image-20250501125602615](/static/images/image-20250501125602615-20250503163755-5e0756fb.png)
